<template>
    <div class="card h-100 p-0 radius-12">
                    ...
                    <tbody>
                        <tr v-for="(user, index) in filteredUsers" :key="index">
                            ...
                            <td class="manage-cell">
                                <button type="button" class="manage-row-button" @click="openManage(user)">
        ...
        <RowManageDialog v-model="manageOpen" :title="selectedUser?.name || ''" :subtitle="selectedUser?.email || ''">
            <button v-if="selectedUser" type="button"><iconify-icon icon="majesticons:eye-line" /> View</button>
            <button v-if="selectedUser" type="button"><iconify-icon icon="lucide:edit" /> Edit</button>
            <button v-if="selectedUser" type="button" class="text-danger" @click="hideUser(selectedUser)"><iconify-icon icon="fluent:delete-24-regular" /> Delete</button>
        </RowManageDialog>
    </div>
</template>
...
export default {
    name: "UserTable",
    components: { Pagination, RowManageDialog },
    data() {
        return {
            users: [
                {
