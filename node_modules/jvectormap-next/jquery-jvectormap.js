(function (global, factory) {
  ...
  (global = global || self, global['jvectormap-next'] = factory());
  ...
  var jqueryMousewheel = createCommonjsModule(function (module, exports) {
  ...
  function installMouseWheelPlugin($) {
    ...
    if (typeof jqueryMousewheel !== 'function') {
      throw new Error('jvectormap-next could not initialize jquery-mousewheel.');
    }
    jqueryMousewheel($);
    return $.event.special.mousewheel;
  }
  function createJVectorMap(jQueryInstance) {
  ...
  * @param {Object} params.regionLabelStyle Set the styles for the regions' labels. Each region or marker has four states: <code>initial</code> (default state), <code>hover</code> (when the mouse cursor is over the region or marker), <code>selected</code> (when region or marker is selected), <code>selectedHover</code> (when the mouse cursor is over the region or marker and it's selected simultaneously). Styles could be set for each of this states. Default value for that parameter is:
  ...
  var globalJQuery = typeof globalThis !== 'undefined' ? globalThis.jQuery : typeof window !== 'undefined' ? window.jQuery : typeof jQuery !== 'undefined' ? jQuery : undefined;
  if (typeof globalJQuery === 'function' && globalJQuery.fn) {
    createJVectorMap(globalJQuery);
  }

  return createJVectorMap;
